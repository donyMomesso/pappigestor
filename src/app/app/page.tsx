  ...
  return (
    ...
    >
      {cross ? (
        ...
        <CheckCircle2 size={16} className={active ? "text-orange-500" : "text-zinc-600"} />
      )}
...
function CardDisc({
  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 p-6 rounded-2xl hover:border-orange-500/50 transition-all group relative overflow-hidden shadow">
      ...
      <div className="text-orange-500 mb-4 group-hover:scale-110 transition-transform duration-300">{icon}</div>
...
// --- PÁGINA PRINCIPAL (MEIO A MEIO, INICIALMENTE MOSTRA METADE) ---
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-orange-500">
      ...
      <main className="pt-24">
        <div className="min-h-[calc(100vh-96px)] relative overflow-hidden">
          <div
            className={`grid grid-cols-1 lg:grid-cols-2 min-h-[calc(100vh-96px)] transition-transform duration-700 ease-in-out ${
              showRight ? "translate-x-0" : "translate-x-0"
            }`}
          >
              ...
              <div className="max-w-xl text-center lg:text-left">
                ...
                <div className="mt-8 flex gap-3">
                  <button
                    ...
                    className="px-4 py-2 rounded-lg bg-zinc-800 border border-zinc-700 text-sm font-bold uppercase"
                  >
                    Ver recursos
                  </button>
                  <button
                    onClick={() => window.scrollTo({ top: document.body.scrollHeight, behavior: "smooth" })}
                    className="px-4 py-2 rounded-lg border border-zinc-700 text-sm font-bold uppercase"
                  >
                    Ir para preços
                  </button>
                </div>
            ...
            <aside
              className={`bg-gradient-to-b from-[#070707] to-[#0b0b0b] px-6 py-12 lg:py-24 overflow-auto transform transition-transform duration-700 ${
              ...
              <div className="max-w-xl mx-auto space-y-10">
                ...
                <div className="flex justify-end lg:hidden">
                  <button
                    ...
                    className="px-3 py-2 rounded-lg border border-zinc-700 text-xs font-bold uppercase"
                  >
                    Fechar
                  </button>
                </div>
                ...
                {/* RODAPÉ CURTO */}
                <div className="text-center text-xs text-zinc-500">Pappi Gestor • Campinas, SP • 2026</div>
              </div>
            </aside>
          </div>
        </div>
