...
function FeatureItem({
  ...
  return (
    ...
    >
      {cross ? (
        <XCircle size={14} className="text-red-900/40" />
      ) : (
        <CheckCircle2
          size={14}
          className={active ? "text-orange-500" : "text-zinc-700"}
        />
      )}
    ...
    <div className="min-h-screen bg-[#050505] text-white selection:bg-orange-500">
      ...
      <nav className="fixed top-0 w-full z-50 p-6 flex justify-between items-center bg-black/50 backdrop-blur-md border-b border-white/5">
        ...
        <div className="flex items-center gap-6">
          ...
          <Link
            href="/cadastro"
            className="bg-orange-600 hover:bg-orange-500 px-6 py-3 rounded-full text-[10px] font-black uppercase italic transition-all shadow-lg shadow-orange-600/20"
          >
            Criar Conta
          </Link>
        </div>
      ...
      <section className="relative pt-48 pb-24 px-6 max-w-5xl mx-auto text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-500 mb-8 animate-pulse">
          <Sparkles size={14} />
          <span className="text-[9px] font-black uppercase tracking-[0.3em] italic text-orange-400">
        ...
        <p className="text-zinc-400 font-medium text-lg max-w-2xl mx-auto mb-12 italic">
          O Pappi Gestor usa IA para ler notas, organizar seu estoque e automatizar suas compras de
          forma automática.
        </p>

        <Link
          href="/cadastro"
          className="inline-flex items-center gap-4 bg-white text-black px-10 py-6 rounded-2xl font-black uppercase italic hover:scale-105 transition-all shadow-2xl"
        >
      ...
      <section className="py-32 px-6 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-end">
          <div className="bg-zinc-900/30 border border-zinc-800 p-10 rounded-[40px] flex flex-col h-full opacity-60">
            ...
            <Link
              href="/cadastro"
              className="w-full py-4 border border-zinc-800 rounded-2xl text-[10px] font-black uppercase text-center hover:bg-zinc-800 transition-all italic"
            >
              Começar
            </Link>
          </div>
          ...
          <div className="bg-orange-600 p-[2px] rounded-[42px] shadow-[0_0_80px_rgba(234,88,12,0.2)] transform md:scale-110 z-20">
            <div className="bg-black rounded-[40px] p-10 flex flex-col h-full relative overflow-hidden">
              ...
              <Link
                href="/cadastro"
                className="w-full py-6 bg-orange-600 text-white rounded-2xl text-[11px] font-black uppercase italic shadow-xl hover:bg-orange-500 transition-all text-center"
              >
                Assinar Agora
              </Link>
            </div>
          ...
          <div className="bg-zinc-900/30 border border-zinc-800 p-10 rounded-[40px] flex flex-col h-full">
            ...
            <Link
              href="/cadastro"
              className="w-full py-4 border border-zinc-700 rounded-2xl text-[10px] font-black uppercase text-center hover:bg-zinc-800 transition-all italic"
            >
              Escolher Gestor
            </Link>
          </div>
